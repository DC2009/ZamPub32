...
{Pages}
  ...
  DefSelPages:Array[1..Prt1MaxPages] of Boolean=(FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,
                                                 FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE);

type
  TPrt1Dlg = class(TForm)
    MainMenu1: TMainMenu;
    Plik: TMenuItem;
  ...
  private
    ...
    Modified:Boolean;
    SelPages:Array[0..Prt1MaxPages-1] of Boolean;
    FilePwd:String;
    Phase:Byte;
   {$IFNDEF DEMO}
    PPos:Integer;
...
procedure Przetarg1(AFileName:String;APrt:Byte; PLN:Real;
...
procedure Przetarg1(AFileName:String;APrt:Byte;
...
procedure TPrt1Dlg.FormCreate(Sender: TObject);
var
  i:Byte;
begin
...
procedure TPrt1Dlg.InitializeSiwz;
var
  F:File;
begin
  ResetPrt1Fields(Self,TenderType,ObjectKind,AmountLevel);
  SuwakiClick(Oba1);
  if OpenMode=oOpen
    then begin
      ClearPrt1Fields(Self);
      ...
      Prt1ValueKindInit(Self,Phase,ObjectKind,AmountLevel);
    end;
...
procedure TPrt1Dlg.PrevBitBtnClick(Sender: TObject);
begin
  PrevBitBtn.Enabled:= Notebook.PageIndex>0;
  NextBitBtn.Enabled:= Notebook.PageIndex<Prt1MaxPages-1;
  if PrevBitBtn.Enabled
    then Notebook.PageIndex:=Notebook.PageIndex-1;
  TabSet.TabIndex:=Notebook.PageIndex;
end;

procedure TPrt1Dlg.NextBitBtnClick(Sender: TObject);
begin
  PrevBitBtn.Enabled:= Notebook.PageIndex>0;
  NextBitBtn.Enabled:= Notebook.PageIndex<Prt1MaxPages-1;
...
procedure TPrt1Dlg.InfoMemo10_2Enter(Sender: TObject);
begin
  WhereAdd:=InfoMemo10_2;
  AddBitBtn.Enabled:=TRUE;
end;

procedure TPrt1Dlg.InfoMemo10_2Exit(Sender: TObject);
begin
  if not AddBitBtn.Focused
    then AddBitBtn.Enabled:=FALSE;
end;

procedure TPrt1Dlg.InfoMemo10_2DblClick(Sender: TObject);
var
  i:Byte;
  j:LongInt;
  Line:String;
...
procedure TPrt1Dlg.WarunkiMemo2DblClick(Sender: TObject);
var
  i:LongInt;
  Comp:TComponent;
begin
...
procedure TPrt1Dlg.WarunkiMemo2Enter(Sender: TObject);
begin
  WhereAdd:=WarunkiMemo2;
  AddBitBtn.Enabled:=TRUE;
end;

procedure TPrt1Dlg.WarunkiMemo2Exit(Sender: TObject);
begin
  if not AddBitBtn.Focused
    then AddBitBtn.Enabled:=FALSE;
end;

procedure TPrt1Dlg.ContentMemo2DblClick(Sender: TObject);
var
  i:LongInt;
  Comp:TComponent;
begin
...
procedure TPrt1Dlg.ContentMemo2Enter(Sender: TObject);
begin
  WhereAdd:=ContentMemo2;
  AddBitBtn.Enabled:=TRUE;
end;

procedure TPrt1Dlg.ContentMemo2Exit(Sender: TObject);
begin
  if not AddBitBtn.Focused
    then AddBitBtn.Enabled:=FALSE;
end;

procedure TPrt1Dlg.OcenaEdit1Enter(Sender: TObject);
begin
  WhereAdd:=OcenaEdit1;
  AddBitBtn.Enabled:=TRUE;
end;

procedure TPrt1Dlg.OcenaEdit1Exit(Sender: TObject);
begin
  if not AddBitBtn.Focused
    then AddBitBtn.Enabled:=FALSE;
end;

procedure TPrt1Dlg.AddBitBtnClick(Sender: TObject);
begin
...
procedure TPrt1Dlg.SaveBtnClick(Sender: TObject);
begin
{$IFDEF NONET}
      ...
      begin
        case TenderType of
          ttNie:
            begin
              DefaultExt:=NieExt;
              Filter:=NieFilter+NieExt;
            end;
          ttOgr:
            begin
              DefaultExt:=OgrExt;
              Filter:=OgrFilter+OgrExt;
            end;
        end;{case}
        if Execute
          then begin
...
procedure TPrt1Dlg.SaveToFile(FileName:String);
var
  FH:File;
  i:Byte;
  Cur:Integer;
...
procedure TPrt1Dlg.LoadFromFile(FileName:String);
var
  i:Integer;
  B:Boolean;
...
procedure TPrt1Dlg.CloseBtnClick(Sender: TObject);
begin
  SiwzClose;
end;

procedure TPrt1Dlg.ZamknijClick(Sender: TObject);
begin
  CloseBtnClick(Sender);
end;

procedure TPrt1Dlg.UstawieniedrukarkiClick(Sender: TObject);
begin
  PrinterSetupDlg.Execute;
end;

procedure TPrt1Dlg.PageConfirmButtonClick(Sender: TObject);
begin
  Modified:=TRUE;
  with TabSet do
    begin
...
procedure TPrt1Dlg.FieldChange(Sender: TObject);
begin
  Modified:=TRUE;
  ClearTabTag;
end;

procedure TPrt1Dlg.CountryRadioGroupClick(Sender: TObject);
begin
  if not PrefKrajowe
    then begin
...
procedure TPrt1Dlg.OfertaRadioGroupClick(Sender: TObject);
begin
...
procedure TPrt1Dlg.NipRB1Click(Sender: TObject);
begin
...
procedure TPrt1Dlg.NipRB2Click(Sender: TObject);
begin
...
procedure TPrt1Dlg.OcenaCBClick(Sender: TObject);
begin
  if (Sender=OcenaCB1)
    then begin
      if OcenaCB1.Checked
...
procedure TPrt1Dlg.OcenaEdit1DblClick(Sender: TObject);
var
  i,j:LongInt;
begin
...
procedure TPrt1Dlg.OcenaSE2Change(Sender: TObject);
begin
  if OcenaSE2.Text=''
    then Exit;
...
procedure TPrt1Dlg.OcenaSE2Exit(Sender: TObject);
begin
  if OcenaSE2.Text=''
    then OcenaSE2.Text:='0';
end;

procedure TPrt1Dlg.SkladDateEdit1_15Change(Sender: TObject);
begin
  OpeningDateEdit1_1Change(Sender);
end;

procedure TPrt1Dlg.OpeningDateEdit1_1Change(Sender: TObject);
var
  by,bm,bd,
  ey,em,ed:Word;
  Ok:Boolean;
...
{$IFNDEF DEMO}
procedure TPrt1Dlg.MakeZamawPrint(var LP:Integer);
var
...
procedure TPrt1Dlg.MakeTerminPrint(var LP:Integer);
var
  p1:PChar;
  s:String;
begin
...
procedure TPrt1Dlg.MakeWarunkiPrint(var LP:Integer);
var
  p1,p2,p3:PChar;
begin
  if Nagwki1.Checked
...
procedure TPrt1Dlg.MakeRodzajPrint(var LP:Integer);
var
  p1,p2:PChar;
  s:String;
begin
...
procedure TPrt1Dlg.MakeInfoPrint(var LP:Integer);
var
...
procedure TPrt1Dlg.MakeWadiumPrint(var LP:Integer);
var
...
procedure TPrt1Dlg.MakeZabezPrint(var LP:Integer);
var
  p1,p2:PChar;
begin
...
procedure TPrt1Dlg.MakeZwiazPrint(var LP:Integer);
var
  p1:PChar;
begin
  if Nagwki1.Checked
...
procedure TPrt1Dlg.MakeSkladPrint(var LP:Integer);
var
  p1,p2,p3,p4,p5,p6,p7,p8,p9,p10:PChar;
begin
  if Nagwki1.Checked
...
procedure TPrt1Dlg.MakeWycofPrint(var LP:Integer);
var
...
procedure TPrt1Dlg.MakeOpenPrint(var LP:Integer);
var
  p1,p2,p3,p4,p5,p6,p7,p8,p9,p10:PChar;
begin
  if Nagwki1.Checked
...
procedure TPrt1Dlg.MakeContentPrint(var LP:Integer);
var
...
procedure TPrt1Dlg.MakeOcenaPrint(var LP:Integer);
var
...
procedure TPrt1Dlg.MakeWyborPrint(var LP:Integer);
var
  p1,p2:PChar;
begin
  if Nagwki1.Checked
...
procedure TPrt1Dlg.MakeUniewazPrint(var LP:Integer);
var
  p1:PChar;
begin
  if Nagwki1.Checked
...
procedure TPrt1Dlg.MakeProtestPrint(var LP:Integer);
var
...
begin
  with Ry do
    begin
      ...
      Font.Style:=[fsBold];
      if TenderType=ttNie
        then s:=sNieograniczonyTitle
      else if TenderType=ttOgr
        then s:=sOgraniczonyTitle;
...
procedure TPrt1Dlg.PrintBitBtnClick(Sender: TObject);
var
  Cur:Integer;
begin
{$IFDEF DEMO}
...
procedure TPrt1Dlg.Drukuj1Click(Sender: TObject);
begin
  PrintBitBtnClick(Sender);
end;

procedure TPrt1Dlg.Przegl1Click(Sender: TObject);
var
  Cur:Integer;
begin
{$IFDEF DEMO}
...
{$IFNDEF DEMO}
procedure TPrt1Dlg.ExportToTxt(FileName:String);
var
  FH:TextFile;
  p,q:PChar;
  i:LongInt;
...
procedure TPrt1Dlg.ExportClick(Sender: TObject);
begin
{$IFDEF DEMO}
  MessageDlg('Nie dostêpne w wersji DEMO',mtInformation,[mbOk],0);
{$ELSE}
...
procedure TPrt1Dlg.IdEditChange(Sender: TObject);
begin
  Modified:=TRUE;
end;

procedure TPrt1Dlg.SuwakiClick(Sender: TObject);
var
...
procedure TPrt1Dlg.TerminActivate(AGroupBox:Byte);
begin
  case AGroupBox of
    1:begin
...
procedure TPrt1Dlg.TerminRb1Click(Sender: TObject);
begin
  TerminActivate(1);
end;

procedure TPrt1Dlg.TerminRB2Click(Sender: TObject);
begin
  TerminActivate(2);
end;

procedure TPrt1Dlg.TabSetClick(Sender: TObject);
begin
...
procedure TPrt1Dlg.ClearTabTag;
begin
  with TabSet do
    if SelPages[TabIndex]=TRUE
      then begin
...
procedure TPrt1Dlg.OknaClick(Sender: TObject);
begin
...
procedure TPrt1Dlg.WadiumRB1_2Click(Sender: TObject);
begin
  WadiumActive(TRUE);
end;

procedure TPrt1Dlg.WadiumRB1_3Click(Sender: TObject);
const
...
procedure TPrt1Dlg.WadiumActive(State:Boolean);
var
  Clr:TColor;
begin
  if State
...
procedure TPrt1Dlg.WadiumEdit2_2Exit(Sender: TObject);
const
...
procedure TPrt1Dlg.InfoCB7Click(Sender: TObject);
var
  x:Boolean;
  cl:TColor;
begin
...
procedure TPrt1Dlg.ZabezActive(State:Boolean);
var
  Clr:TColor;
begin
  if State
...
procedure TPrt1Dlg.ZabezRB1_2Click(Sender: TObject);
begin
  ZabezActive(TRUE);
end;

procedure TPrt1Dlg.ZabezRb1_3Click(Sender: TObject);
begin
  ZabezActive(FALSE);
end;

procedure TPrt1Dlg.Save1Click(Sender: TObject);
begin
  SaveBtnClick(Sender);
end;

procedure TPrt1Dlg.SaveAs1Click(Sender: TObject);
var
  FN:String;
begin
  FN:=FileName;
...
procedure TPrt1Dlg.Nagwki1Click(Sender: TObject);
begin
  Nagwki1.Checked:=not Nagwki1.Checked;
end;

procedure TPrt1Dlg.Opis1Click(Sender: TObject);
begin
  Opis1.Checked:=not Opis1.Checked;
end;

procedure TPrt1Dlg.Ident1Click(Sender: TObject);
begin
  Ident1.Checked:=not Ident1.Checked;
end;

procedure TPrt1Dlg.Wartzam1Click(Sender: TObject);
begin
  WartZam1.Checked:=not WartZam1.Checked;
end;

procedure TPrt1Dlg.Value1Click(Sender: TObject);
begin
...
procedure TPrt1Dlg.Rodzaj1Click(Sender: TObject);
begin
  RodzajDlg:=TRodzajDlg.Create(Self);
  with RodzajDlg do
    begin
      SetEdit(ttNie,ObjectKind);
      if ShowModal=mrOk
        then begin
          if ObjectKind<>OKind
            then begin
