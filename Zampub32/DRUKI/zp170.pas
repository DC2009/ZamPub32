...
begin
  ...
  ZP170Dlg:=TZp170Dlg.Create(Nil);
  Screen.Cursor:=Cur;
  ZP170Dlg.ShowModal;
  ZP170Dlg.Free;
end;

procedure TZp170Dlg.TimeEditExit(Sender: TObject);
var
  s:String[5];
  Err:Boolean;
begin
...
procedure TZp170Dlg.NumEditKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9',#8])
    then begin
      Key:=#0;
...
procedure TZp170Dlg.FormCreate(Sender: TObject);
begin
  RB1_21.Checked:=TRUE;
  RB1_21Click(Sender);
...
procedure TZp170Dlg.RB1_21Click(Sender: TObject);
begin
...
procedure TZp170Dlg.RB1_22Click(Sender: TObject);
begin
...
procedure TZp170Dlg.MakeBox1(Ry:TRyPrinter; var PPos:Integer);
var
...
begin
  with Ry do
    begin
      ...
      AddZp1Box(Ry,'1',[p1,p2,p3,p4,p5,p6,p7],[1,1,1,1,1,1,1],ZP170Tit1+Zp170Tit2,'170',NumEdit.Text,PrintSpace,PPos);
      StrDispose(p1);
      StrDispose(p2);
      StrDispose(p3);
      StrDispose(p4);
...
procedure TZp170Dlg.MakeBox2(Ry:TRyPrinter; var PPos:Integer);
var
...
begin
  with Ry do
    begin
      ...
      AddZp1Box(Ry,'2',[p1,p2,p3,p4,p5,p6],[1,1,1,1,1,1],ZP170Tit1+Zp170Tit2,'170',NumEdit.Text,PrintSpace,PPos);
      StrDispose(p1);
      StrDispose(p2);
      StrDispose(p3);
      StrDispose(p4);
...
procedure TZp170Dlg.MakeBox3(Ry:TRyPrinter; var PPos:Integer);
var
  p:PChar;
begin
  with Ry do
    begin
      ...
      AddZp1Box(Ry,'3',[p],[1],ZP170Tit1+Zp170Tit2,'170',NumEdit.Text,PrintSpace,PPos);
      StrDispose(p);
    end;
end;

procedure TZp170Dlg.MakeBox4(Ry:TRyPrinter; var PPos:Integer);
var
...
begin
  with Ry do
    begin
      ...
      AddZp1Box(Ry,'4',[p1,p2,p3,p4,p5],[1,1,1,1,1],ZP170Tit1+Zp170Tit2,'170',NumEdit.Text,PrintSpace,PPos);
      StrDispose(p1);
      StrDispose(p2);
      StrDispose(p3);
      StrDispose(p4);
...
procedure TZp170Dlg.MakeUZPPage(Ry:TRyPrinter;PPos:Integer);
var
  X:Integer;
p:PChar;
begin
  with Ry do
    begin
      ...
      PPos:=YTOff;
      MakeZpNumStr(Ry,XROff-Xmm(4),'170',PPos);
      PPos:=PPos+Ymm(10);
...
begin
    with Ry do
      begin
        ...
        MakeHeader(Ry,Zp170Tit1+Zp170Tit2,'170',NumEdit.Text,'',PPos);
...
procedure TZp170Dlg.PreviewBtnClick(Sender: TObject);
var
  Cur:Integer;
begin
{$IFDEF NONET}
...
procedure TZp170Dlg.PrintBtnClick(Sender: TObject);
var
  Cur:Integer;
begin
{$IFDEF NONET}
...
begin
  ...
  try
    ...
    try
      SeedKey:=SKey;
      SaveString(Zp170FileHdr,FHandle);
...
procedure TZp170Dlg.OpenBtnClick(Sender: TObject);
begin
...
procedure TZp170Dlg.SaveBtnClick(Sender: TObject);
begin
...
procedure TZp170Dlg.FormDestroy(Sender: TObject);
begin
  if FileIsOpen
    then begin
      CloseFile(FHandle);
...
procedure TZp170Dlg.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13
    then begin
      Key:=#0;
...
procedure TZp170Dlg.OKBtnClick(Sender: TObject);
var
  x:Integer;
begin
...
procedure TZp170Dlg.SiwzBtnClick(Sender: TObject);
var
  p:PChar;
begin
{$IFDEF DEMO}
...
{$ELSE}
    ...
    OpenDialog.DefaultExt:='170';
    OpenDialog.Filter:='Druki ZP170|*.170';
{$ENDIF}
end;

procedure TZp170Dlg.HelpBtnClick(Sender: TObject);
begin
